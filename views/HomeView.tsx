...
const HomeView: React.FC<HomeViewProps> = ({ onLogin, onAdminLogin, onShowSignUp, t }) => {
            ...
            <main className="pt-24">
                    ...
                    <div className="flex flex-col md:flex-row items-center">
                        <div className="md:w-1/2 mb-12 md:mb-0 md:pr-12">
                            <h2 className="text-4xl lg:text-5xl font-extrabold leading-tight mb-4 animate-fade-in-down">
                                {t('homeTitle1')}
                                <br />
                                <span className="text-blue-600 dark:text-blue-400">{t('homeTitle2')}</span>
                            </h2>
                ...
                <section className="bg-white dark:bg-gray-800 py-20">
                    <div className="container mx-auto px-6 text-center">
                        <h2 className="text-3xl font-bold mb-3">{t('howItWorks')}</h2>
                        <p className="text-gray-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto">{t('howItWorksSubtitle')}</p>
